...
class Item(BaseModule):
    ...
    def get_recommend_cats(self, **kwargs):
        """
        https://open.shopee.com/documents?module=2&type=1&id=456&version=1
        ...
        :param name:The title of a particular item, used to get recommended category ids.
        :return:

        """
        return self.client.execute("item/categories/get_recommend", "POST", kwargs)
